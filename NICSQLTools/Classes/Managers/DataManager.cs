...
namespace NICSQLTools.Classes.Managers
{
    public class DataManager
    {
        ...
        public static Dictionary<string, int> GetCurrentAssemblyFiles()
        {
            ...
            Asm.Add("DevExpress.DataAccess.v15.2.dll", 152900000);
            ...
            Asm.Add("DevExpress.Sparkline.v15.2.Core.dll", 152900000);
            Asm.Add("DevExpress.Utils.v15.2.dll", 152900000);
            Asm.Add("DevExpress.Utils.v15.2.UI.dll", 152900000);
            Asm.Add("DevExpress.Xpo.v15.2.dll", 152900000);
            Asm.Add("DevExpress.XtraBars.v15.2.dll", 152900000);
            Asm.Add("DevExpress.XtraCharts.v15.2.dll", 152900000);
            Asm.Add("DevExpress.XtraCharts.v15.2.Extensions.dll", 152900000);
            Asm.Add("DevExpress.XtraCharts.v15.2.UI.dll", 152900000);
            ...
            Asm.Add("DevExpress.XtraMap.v15.2.dll", 152900000);
            Asm.Add("DevExpress.XtraNavBar.v15.2.dll", 152900000);
            ...
            Asm.Add("DevExpress.XtraVerticalGrid.v15.2.dll", 152900000);
            Asm.Add("DevExpress.XtraWizard.v15.2.dll", 152900000);

            Asm.Add("FXFW.dll", 1006);
