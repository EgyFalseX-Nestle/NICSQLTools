...
namespace NICSQLTools.Classes.Managers
{
    public class DataManager
    {
        ...
        public static Dictionary<string, int> GetCurrentAssemblyFiles()
        {
            ...
            Asm.Add("DevExpress.Dashboard.v14.2.Core.dll", 142415030);
            Asm.Add("DevExpress.Dashboard.v14.2.Win.dll", 142415030);
