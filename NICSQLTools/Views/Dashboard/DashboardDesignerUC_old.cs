...
{
    public partial class DashboardDesignerUC_old : DevExpress.XtraEditors.XtraUserControl
    {

        #region -   Variables   -
        private static readonly ILog Logger = log4net.LogManager.GetLogger(typeof(DashboardDesignerUC_old));
        ...
        #endregion
        #region -   Functions   -
        public DashboardDesignerUC_old()
        {
            InitializeComponent();
        }
        void LoadData()
