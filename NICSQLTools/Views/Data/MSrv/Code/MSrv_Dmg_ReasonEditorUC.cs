...
{
    public partial class MSrv_Dmg_ReasonEditorUC : XtraUserControl
    {
        ...
        NICSQLTools.Data.dsMSrcTableAdapters.MSrv_Dmg_ReasonTableAdapter adp = new NICSQLTools.Data.dsMSrcTableAdapters.MSrv_Dmg_ReasonTableAdapter();
        int _id;
        #endregion
        #region - Fun -
        public MSrv_Dmg_ReasonEditorUC(NICSQLTools.Data.dsData.AppRuleDetailRow ruleElement)
        {
            InitializeComponent();
            _elementRule = ruleElement;
            var newId = adp.NewId();
            if (newId != null) _id = (int)newId;
        }
        void LoadData()
        {
        ...
        private void UOW_BeforeCommitTransaction(object sender, DevExpress.Xpo.SessionManipulationEventArgs e)
        {
            ...
            {
                if (item.GetMemberValue("msrv_dmg_reason_id") == null)
                    item.SetMemberValue("msrv_dmg_reason_id", parts);
