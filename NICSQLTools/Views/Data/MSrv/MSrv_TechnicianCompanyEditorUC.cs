...
{
    public partial class MSrv_TechnicianCompanyEditorUC : XtraUserControl
    {

        #region - Var -
        private static readonly log4net.ILog Logger = log4net.LogManager.GetLogger(typeof(NICSQLTools.Views.Data.MSrv.MSrv_TechnicianCompanyEditorUC));
        NICSQLTools.Data.dsData.AppRuleDetailRow _elementRule = null;
        NICSQLTools.Data.dsMSrcTableAdapters.MSrv_TechnicianCompanyTableAdapter adp = new NICSQLTools.Data.dsMSrcTableAdapters.MSrv_TechnicianCompanyTableAdapter();
        #endregion
        #region - Fun -
        public MSrv_TechnicianCompanyEditorUC(NICSQLTools.Data.dsData.AppRuleDetailRow RuleElement)
        {
            InitializeComponent();
        ...
        private void gridViewMain_InitNewRow(object sender, DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs e)
        {
            ...
            //row.SetMemberValue("TechnicianCompanyId", (int)adp.NewId());
