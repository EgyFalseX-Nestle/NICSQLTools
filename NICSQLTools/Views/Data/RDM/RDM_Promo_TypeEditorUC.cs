...
{
    public partial class RDM_Promo_TypeEditorUC : XtraUserControl
    {

        #region - Var -
        private static readonly log4net.ILog Logger = log4net.LogManager.GetLogger(typeof(NICSQLTools.Views.Data.RDM.RDM_Promo_TypeEditorUC));
        NICSQLTools.Data.dsData.AppRuleDetailRow _elementRule = null;
        NICSQLTools.Data.dsRDMTableAdapters.RDM_Promo_TypeTableAdapter adp = new NICSQLTools.Data.dsRDMTableAdapters.RDM_Promo_TypeTableAdapter();
        //int _parts;
        #endregion
        #region - Fun -
        public RDM_Promo_TypeEditorUC(NICSQLTools.Data.dsData.AppRuleDetailRow RuleElement)
        {
            InitializeComponent();
            _elementRule = RuleElement;
            //_parts = (int)adp.NewId();
        }
        void LoadData()
        {
