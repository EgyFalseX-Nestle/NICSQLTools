...
{
    public partial class TSrv_RoutePlateEditorUC : XtraUserControl
    {
        ...
        #endregion
        #region - Fun -
        public TSrv_RoutePlateEditorUC(NICSQLTools.Data.dsData.AppRuleDetailRow RuleElement)
        {
            InitializeComponent();
            _elementRule = RuleElement;
            Classes.Managers.DataManager.SetAllCommandTimeouts(plateTableAdapter, Classes.Managers.DataManager.ConnectionTimeout);
        }
        void LoadData()
        {
            ...
            System.Threading.ThreadPool.QueueUserWorkItem((o) => 
            {
                ...
                {
                    plateTableAdapter.Fill(dsTSrv.Plate);
        ...
        private void bbiRefresh_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (MsgDlg.Show("Are You Sure ?", MsgDlg.MessageType.Question) == DialogResult.No)
                return;
            plateTableAdapter.Fill(dsTSrv.Plate);
            UOW.DropIdentityMap();UOW.DropChanges();
            XPSCS.Reload();
