...
{public partial class MSrv_03 : DevExpress.XtraEditors.XtraUserControl
    {
        public MSrv_03()
        {
            InitializeComponent();
            DataManager.SetAllCommandTimeouts(qry03TableAdapter, DataManager.ConnectionTimeout);
        }
        ...
        private void bbiExecute_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            System.Threading.ThreadPool.QueueUserWorkItem((o) =>
            {
                ...
                {
                    qry03TableAdapter.Fill(dsMSrc.Qry03, (DateTime)bbiStartDate.EditValue, (DateTime)bbiEndDate.EditValue, UserManager.defaultInstance.User.UserId);
