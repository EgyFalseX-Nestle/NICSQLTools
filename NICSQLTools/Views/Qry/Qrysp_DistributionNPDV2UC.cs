...
{
    public partial class Qrysp_DistributionNPDV2UC : DevExpress.XtraEditors.XtraUserControl
    {
  
        #region -   Variables   -
        private static readonly ILog Logger = log4net.LogManager.GetLogger(typeof(Qrysp_DistributionNPDV2UC));
        #endregion
        #region -   Functions   -
        public Qrysp_DistributionNPDV2UC()
        {
            InitializeComponent();
        ...
        void LoadData()
        {
            ...
            DevExpress.Xpo.DB.SelectedData DataObj = NICSQLTools.Data.IC_DB.SprocHelper.Execsp_DistributionNPDV2(DevExpress.Xpo.XpoDefault.Session, Convert.ToDateTime(bbiStartDate.EditValue),
        ...
        private void Qrysp_DistributionNPDV1UC_Load(object sender, EventArgs e)
        {
